    ...
    <div class="row header" style="background-color: rgb(66, 64, 81); padding: 10px">
        ...
        <div class="col col-md-6 justify-content-end flex-row" style="display: flex;">
            ...
            <a class="btn btn-success" style="margin-left: 20px; width:200px"
               href="<%=request.getContextPath()%>/customers/show-add-page"><i
                    ...
                    <c:forEach var="c" items="${customerList}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="show-edit-page?id=<c:out value='${c.customerCode}'/>"><i
                                        class="fa fa-pen text-warning " style="margin-right: 10px;"></i></a>
                                <a href="delete?id=<c:out value='${c.customerCode}'/>" onclick="return confirm('Chắc là muốn xoá khum?')"><i
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <c:if test="${currentPage != 1}">
                                <li class="page-item">
                                    <a class="page-link" href="<%=request.getContextPath()%>/customers/list?pageNumber=${currentPage-1}">Previous</a>
                                </li>
                            </c:if>
                            <c:if test="${currentPage == 1}">
                            ...
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                ...
                                <li class="page-item active">
                                    <a class="page-link" href="<%=request.getContextPath()%>/customers/list?pageNumber=${i}">
                                        <c:out value="${i}"/>
                                    </a>
                                </li>
                                </c:if>
                            ...
                            <c:if test="${currentPage != totalPages}">
                                <li class="page-item">
                                    <a class="page-link" href="<%=request.getContextPath()%>/customers/list?pageNumber=${currentPage+1}">Next</a>
                                </li>
                            </c:if>
                            <c:if test="${currentPage == totalPages}">
                                <li class="page-item disabled">
